  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 overflow-y-auto">
      ...
      <motion.div 
        ...
        className="bg-white rounded-3xl shadow-xl w-full max-w-2xl overflow-hidden relative z-10 my-auto"
      >
        {/* Header */}
        <div className="px-8 py-6 border-b border-slate-100 bg-slate-50/60 flex items-center justify-between">
        ...
        <form onSubmit={handleSubmit} className="p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="space-y-1.5">
              ...
              <div
                ...
                className={`flex items-center gap-3 w-full px-4 py-3 rounded-xl border-2 cursor-pointer transition-all duration-200 ${
                  errors.profile ? "border-rose-400 bg-rose-50" : "border-slate-200 bg-white hover:border-tech-blue-400 hover:bg-tech-blue-50/30"
                }`}
              >
                {profilePreview ? (
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <select value={form.role_id} onChange={set("role_id")} className={`${inputClass("role_id")} appearance-none bg-white`}>
          ...
          <div className="mt-8 pt-6 border-t border-slate-100 flex justify-end gap-3">
            ...
            <motion.button
              ...
              className="flex items-center justify-center gap-2 px-8 py-2.5 bg-tech-blue-600 text-white text-sm font-bold rounded-xl shadow-lg shadow-tech-blue-500/30 hover:shadow-xl transition-all disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {isLoading ? (
