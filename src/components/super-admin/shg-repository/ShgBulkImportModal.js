                    ...
                    >
                        ...
                        <div className="px-6 py-5 border-b border-slate-100 flex justify-between items-center">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-lg font-bold text-slate-800">Import SHGs</h3>
                                    <p className="text-xs text-slate-500">Bulk upload Self Help Groups via CSV</p>
                                </div>
                            </div>
                            <button
                                onClick={onClose}
                        ...
                        <div className="p-6 space-y-5">
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full bg-slate-50 border border-slate-200 text-slate-800 text-xs rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 block p-2 transition-all outline-none"
                                    >
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full bg-slate-50 border border-slate-200 text-slate-800 text-xs rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 block p-2 transition-all disabled:opacity-50 outline-none"
                                    >
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-slate-700 mb-1.5">Village <span className="text-rose-500">*</span></label>
                                    <select
                            ...
                            <div className="bg-slate-50 rounded-xl p-3 border border-slate-100">
                                <code className="text-[10px] text-slate-500 leading-relaxed block overflow-x-auto whitespace-nowrap text-center">
                                    ...
                                    >
                                        <div className="grid grid-cols-2 gap-3">
                                            <div className="flex items-center gap-3 p-3 bg-emerald-50 border border-emerald-100 rounded-xl">
                                                ...
                                                <div>
                                                    <p className="text-lg font-extrabold text-emerald-700">{importResult.added || 0}</p>
                                            ...
                                            <div className="flex items-center gap-3 p-3 bg-amber-50 border border-amber-100 rounded-xl">
                                                ...
                                                <div>
                                                    <p className="text-lg font-extrabold text-amber-700">{importResult.skipped || 0}</p>
                        ...
                        <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex justify-end gap-3">
                            ...
                            {!importResult && (
                                <button
                                    onClick={onImport}
                                    disabled={!importFile || !selectedDistrict || !selectedTaluka || !selectedVillage || importLoading}
                                    className="px-5 py-2.5 text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-xl shadow-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                                >
                                    {importLoading ? (
                                        <><motion.div animate={{ rotate: 360 }} transition={{ duration: 1, repeat: Infinity, ease: "linear" }}><Upload size={15} /></motion.div> Processing...</>
                                    ) : (
                                        <><Upload size={15} /> Import SHGs</>
                                    )}
                                </button>
                            )}
                        </div>
