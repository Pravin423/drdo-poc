                    ...
                    >
                        <div className="p-8 text-center flex flex-col items-center">
                            ...
                            <div className="flex flex-col gap-3 w-full">
                                <button
                                    onClick={onConfirm}
                                    className="w-full py-4 text-[15px] font-bold text-white bg-gradient-to-r from-[#1a2e7a] to-[#2a44a1] rounded-2xl shadow-xl shadow-indigo-900/20 hover:shadow-2xl hover:-translate-y-0.5 transition-all active:scale-[0.98]"
                                >
                                    Yes, Save Changes
                                </button>
                                <button
                ...
                <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
                    ...
                    >
                        <div className="p-8 text-center flex flex-col items-center">
                            ...
                            <h3 className="text-2xl font-black text-slate-800 mb-3 tracking-tight">Delete District?</h3>
                            <p className="text-[15px] font-medium text-slate-500 mb-8 px-4 leading-relaxed">
