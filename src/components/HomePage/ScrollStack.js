...
export const ScrollStackItem = ({ children, itemClassName = '' }) => (
  <div
    className={`scroll-stack-card relative w-full h-[400px] my-8 p-10 md:p-12 rounded-[40px] box-border origin-top will-change-transform ${itemClassName}`.trim()}
    style={{
...
const ScrollStack = ({
  ...
  useLayoutEffect(() => {
    ...
    // Cache initial positions before applying any transforms
    const endElement = useWindowScroll
      ? document.querySelector('.scroll-stack-end')
  ...
  return (
    <div className={containerClassName} ref={scrollerRef} style={containerStyles}>
      <div className="scroll-stack-inner pt-[10vh] px-6 md:px-20 pb-[20rem]">
        {children}
