export default async function handler(req, res) {
  ...
  try {
    const backendResponse = await fetch("https://goadrda.runtime-solutions.net/admin/api/crp-village-mapping", {
      method: "GET",
      headers: {
    ...
    console.error("CRP Village Mapping proxy error:", error);
