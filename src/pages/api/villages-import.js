...
export default async function handler(req, res) {
  ...
  try {
    ...
    const apiRes = await fetch(`${API_BASE}/villages/import`, {
      method: "POST",
    ...
    // Some APIs return "success" instead of "status", unify response
    if (apiRes.ok) {
    ...
    console.error("[villages-import.js] Proxy error:", err.message);
