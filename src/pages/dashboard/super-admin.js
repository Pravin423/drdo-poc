          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            >
              ...
              <div className="flex items-center justify-between mb-8">
                <div>
                  <h2 className="text-lg font-bold text-slate-900 tracking-tight">City-wise CRP Distribution (Goa)</h2>
                  <p className="text-sm text-slate-500">Active CRPs in North and South Goa across major cities</p>
                </div>
              ...
              <div className="flex-1 w-full min-h-[300px]">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={chartData} margin={{ top: 10, right: 20, left: -10, bottom: 0 }}>
                    ...
                    <Area type="monotone" dataKey="northGoa" stroke="#2563EB" strokeWidth={3} fill="url(#northGradient)" animationDuration={1400} />
                    <Area type="monotone" dataKey="southGoa" stroke="#10B981" strokeWidth={3} fill="url(#southGradient)" animationDuration={1400} />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
