          ...
          <AnimatePresence>
            {error && !loading && (
              ...
              >
                ...
                <button onClick={fetchProfile} className="text-xs font-bold text-rose-600 underline underline-offset-2">
                  Retry
                </button>
              </motion.div>
            )}
                  ...
                  <div className="flex items-end gap-5 -mt-10 mb-5">
                    ...
                    <div className="pb-1 flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap gap-2 mt-1.5">
                        <InfoChip icon={ShieldCheck} text={role} color="bg-blue-50 text-blue-700" />
                        <InfoChip
